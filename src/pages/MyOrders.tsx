            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-6">
                        ...
                        <p className="text-sm text-app-text-light mb-4">Start shopping and check your orders here.</p>
                        ...
                        {orders.map((order) => (
                            <Link to={`/orders/${order._id}`} key={order._id} className="block max-w-4xl bg-white rounded-2xl p-5 hover:shadow transition-all">
                                ...
                                <div className="flex justify-between items-center pt-3 text-sm">
                                    ...
                                    <span className="font-semibold text-app-green">{order.total.toFixed(3)} {currency}</span>
                                </div>
                            </Link>
                        ))}
                    </div>
