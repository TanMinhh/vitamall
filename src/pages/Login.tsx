    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-app-green relative items-center justify-center">
                <img src={heroSectionData.hero_image} alt="" className="absolute inset-0 object-cover h-full bg-center opacity-20" />
                <div className="relative text-center px-12">
                    <h2 className="text-4xl font-semibold text-white mb-4">Welcome back to VitaMall</h2>
                ...
                <div className="w-full max-w-md">
                    <div className="text-center mb-8">
                        <Link to="/" className="inline-flex items-center gap-2 mb-6">
                            ...
                            <span className="text-2xl font-semibold text-app-green">VitaMall</span>
                        </Link>
                        ...
                        <label className="text-sm flex flex-col gap-1">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    placeholder="vitamall@example.com"
                                    className="w-full pl-11 pr-4 py-3 text-sm bg-white rounded-xl border not-focus:border-app-border transition-all" />
                            </div>
                        </label>
                        <label className="text-sm flex flex-col gap-1">
